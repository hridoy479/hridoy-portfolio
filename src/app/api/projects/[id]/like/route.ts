...
export async function POST(
  ...
  try {
    ...
    if (existingLike) {
      ...
      const { error: decrementError } = await supabase.rpc('decrement_project_likes', { project_id: parseInt(id) });
      ...
      const { error: incrementError } = await supabase.rpc('increment_project_likes', { project_id: parseInt(id) });
